    ...
    )
{
    ...
    let response = egui::Window::new("Cluster role details").min_width(800.0).collapsible(false).resizable(true).open(&mut cluster_role_details_window.show).show(ctx, |ui| {
        ui.horizontal(|ui| {
